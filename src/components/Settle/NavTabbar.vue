...
<div class="witype" @click="paymentMethod('MEMBER_CARD')">
        <img class="hui" src="../../assets/img/card_yellow.png" alt="">
        <p class="zie">会员卡支付</p>
    </div>
      </div>
    </div>
      ...
      setTimeout(function() {
        window.location.href =
          ...
          utils.getCookie("memberCode");
            ...
            // let goodsName="请使用"+paymentName+"付款";//商品名称
            //            //语音播放
...
/* text-align:left; */
height: .460405rem;
line-height: .460405rem;
margin-top: .244499rem;
}
.fen{
  float: left;
